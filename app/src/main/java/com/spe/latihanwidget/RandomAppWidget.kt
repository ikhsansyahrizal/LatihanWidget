 ...
 */
class RandomAppWidget : AppWidgetProvider() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (intent.action == WIDGET_CLICK) {
            ...
            val views = RemoteViews(context.packageName, R.layout.random_app_widget)
...
internal fun updateAppWidget(
    ...
    val intent = Intent(context, RandomAppWidget::class.java)
    intent.action = RandomAppWidget.WIDGET_CLICK
    intent.putExtra(RandomAppWidget.WIDGET_ID_EXTRA, appWidgetId)
